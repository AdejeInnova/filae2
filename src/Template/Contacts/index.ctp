        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover">
            <tr>
              ...
              <th><?= $this->Paginator->sort('companie_id') ?></th>
            ...
            <?php foreach ($contacts as $contact): ?>
              <tr>
                ...
                <td><?= $contact->has('company') ? $this->Html->link($contact->company->tradename, ['controller' => 'Companies', 'action' => 'view', $contact->company->id]) : '' ?></td>
